...
<body scroll="auto">
	<!-- 폼태그 -->
	<section class="contact_form" id="contact_form" style="padding-bottom:250px">
		<h3>연락처</h3>
		<div class="content">
			<div class="image">
		...
		<form id="contact" action="contact_sys.php" method="post">
			<table>
				...
				<tr>
					...
					<td colspan="3">
						<h3><input type="checkbox" name="checker1" id="checker1" required style="width: 16px; height: 16px;"><label for="checker1">소비자 권익보호에 관한 사항</label></h3>
						<p>방문자님께서는 아래의 동의를 거부할 수 있으며, 이에 동의하지 않으실 경우 본 메일 송신 서비스 사용이 제한될 수 있습니다.</p>
						<h3><input type="checkbox" name="checker2" id="checker2" required style="width: 16px; height: 16px;"><label for="checker2">개인(신용)정보의 수집·이용에 관한 사항 </label></h3>
